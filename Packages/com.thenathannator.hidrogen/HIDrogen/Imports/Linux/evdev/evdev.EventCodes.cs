...
namespace HIDrogen.Imports.Linux
{
    ...
    internal enum EvdevRelativeAxis
    {
        REL_X = 0x00,
        REL_Y = 0x01,
        REL_Z = 0x02,
    ...
    internal enum EvdevAbsoluteAxis
    {
        ABS_X = 0x00,
        ABS_Y = 0x01,
        ABS_Z = 0x02,
    ...
    internal enum EvdevMiscellaneous
    {
        MSC_SERIAL = 0x00,
        MSC_PULSELED = 0x01,
        MSC_GESTURE = 0x02,
